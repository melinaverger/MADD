...
def fair_imporved_predicton(data, lambda_):
    """
...
def plot_func_2D(Lambda, total_loss, accu_loss, madd,
                 ylim=None, xlable_args=None, ylabel_args=None, title_args=None, legend_args=None):
    """
    ...
    default_xlabel_args = {'xlabel': 'lambda', 'fontsize': 14, 'fontweight': 'bold'}
    default_ylabel_args = {'ylabel': 'loss', 'fontsize': 14, 'fontweight': 'bold'}
    default_title_args = {'label': 'Effect of lambda on \nthe objective function, accuracy loss and Fairness loss', 'fontsize': 14, 'fontweight': 'bold'}
    default_legend_args = {}
