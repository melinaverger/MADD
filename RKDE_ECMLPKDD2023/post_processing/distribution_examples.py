...
"""
Define the density functions that we use as examples， and Define their inverse cumulative distribution functions, 
in order to generate the variables that follows the distributions
"""
