...
def plot_2histograms(Q0, Q1, nb_bins, density=False, weight=True,
    ...
    :return: None
    """
    args0 = {'x': Q0, 'bins': nb_bins, 'range': (0, 1), 'alpha': 0.5, 'label': 'G0'}
    args1 = {'x': Q1, 'bins': nb_bins, 'range': (0, 1), 'alpha': 0.5, 'label': 'G1'}
    if density:
        args0['density'] = True
        args1['density'] = True
    if weight:
    ...
    default_xlabel_args = {'xlabel': 'Predicted Probability', 'fontsize': 14, 'fontweight': 'bold'}
    default_ylabel_args = {'ylabel': 'Proportion', 'fontsize': 14, 'fontweight': 'bold'}
    default_title_args = {'label': 'Histograms', 'fontsize': 14, 'fontweight': 'bold'}
    default_legend_args = {'fontsize': 14}
    ...
    plt.legend(**default_legend_args)
