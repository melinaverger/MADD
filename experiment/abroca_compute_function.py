"""
From https://github.com/VaibhavKaushik3220/abroca
"""

from abroca_utils import *
import pandas as pd
import numpy as np
...
def compute_abroca(
    ...
    """
    model_name - name of the current model used (string)  # me
    ...
    if plot_slices == True:
        ...
        slice_plot(
            ...
            majority_roc_y,
            minority_roc_y,
            majority_group_name=protected_attr_col + " " + str(majority_protected_attr_val),  # me
            minority_group_name=protected_attr_col + " " + str(mino),  # me
            fout=file_name,
        )
