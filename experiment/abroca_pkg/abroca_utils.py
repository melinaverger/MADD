...
def slice_plot(
    ...
    slice_value - ABROCA value computed before  # added
    ...
    if "nb" in model_name:
        plt.title("{b} - ABROCA = {a}".format(a=round(slice_value, 2), b="NB"))  # added
    else:
    ...
    plt.plot(
        ...
        label="{o}".format(o=majority_group_name),  # added
        linestyle="-",
        color="r",
    )
    plt.plot(
        ...
        label="{o}".format(o=minority_group_name),  # added
        linestyle="-",
        color="b",
    )
    plt.fill(
